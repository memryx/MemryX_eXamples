...
class AudioClassify:
    ...
    def _run_preprocess_model(self, waveform):
        ...
        preprocessed_waveform = output_details[1]['index'] 
    ...
    def _get_final_prediction(self):
        ...
        print('The predicted class is:', self.labels[final_scores.mean(axis=0).argmax()])
...
def main():
    ...
    # Create the parser
    parser = argparse.ArgumentParser(description = "Audio classification with MXA")

    # Add arguments
    parser.add_argument('--audio_file_path', 
                        type = str, 
                        default = '../../assets/44737-5-0-1.wav',
    ...
    # Perform inference
    audioclassify.run(audio_file_path)
