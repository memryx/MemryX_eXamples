...
import base64
import subprocess
from ser import SpeechEmotionRecognition
from werkzeug.utils import secure_filename
import ffmpeg

# Dict that contains emotions and the corresponding images
emotion_images = {
            "anger": "static/images/angry.jpg",
            "boredom": "static/images/bored.jpg",
            "disgust": "static/images/disgust.jpg",
            "anxiety_fear": "static/images/anxious.jpg",
            "happiness": "static/images/happy.jpg",
            "sadness": "static/images/sad.jpg",
    ...
    if request.method == 'POST':
        ...
        if 'file' in request.files:
            ...
            if file and allowed_file(file.filename):
                ...
                # Perform inference
                ser.run(input_path)
                result = ser.get_classification_result()
                intermediate_class_predictions = ser.get_intermediate_class_predictions()

                result_image_url = emotion_images.get(result, None)

                os.remove(input_path)  # Clean up converted file
                return render_template('index.html', classification_result=result, intermediate_predictions=intermediate_class_predictions, result_image_url=result_image_url)
