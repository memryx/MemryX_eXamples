...
| [**Segmentation using YOLOv8**](video_inference/segmentation_yolov8/README.md) | Perform instant segmentation on video in real time | YOLOv8 Nano Segmentation | ![python-badge] ![cpp-badge] | <img src="https://upload.wikimedia.org/wikipedia/commons/3/35/Tux.svg" alt="Linux" width="20" height="20"> | <img src="video_inference/segmentation_yolov8/assets/segmentation.png" alt="Yolov8n Segmentation Preview" height="50"> |
