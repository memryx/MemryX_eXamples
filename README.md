...
| [**Personal protective equipment detection using YOLOv8**](video_inference/ppe_detection_tracking_yolov8/README.md) | Detect personal protective equipment for safety purposes   | YOLOv8      | ![python-badge] | <img src="https://upload.wikimedia.org/wikipedia/commons/3/35/Tux.svg" alt="Linux" width="20" height="20"> | <img src="video_inference/ppe_detection_tracking_yolov8/assets/ppe_detection.gif" alt="Yolov8 ppe detection Preview" height="50"> |
| [**Object Blurring using YOLOv8**](video_inference/object_blurring_yolov8/README.md) | Protect individuals privacy in a video stream       | YOLOv8         | ![python-badge] | <img src="https://upload.wikimedia.org/wikipedia/commons/3/35/Tux.svg" alt="Linux" width="20" height="20"> | <img src="video_inference/object_blurring_yolov8/assets/object_blurring.gif" alt="Yolov8 object blurring Preview" height="50"> |
| [**Object Tracking using YOLOv8**](video_inference/object_tracking_yolov8/README.md) | Object tracking in a video stream       | YOLOv8         | ![python-badge] | <img src="https://upload.wikimedia.org/wikipedia/commons/3/35/Tux.svg" alt="Linux" width="20" height="20"> | <img src="video_inference/object_tracking_yolov8/assets/object_tracking.gif" alt="YOLOv8 + Bytetrack object tracking preview" height="50"> |
