...
private:
    ...
    /**
     * @brief Show number of viewer to the display, call after Addviewer/SetSquareLayout.
     * @param num_channels How much channel viewer to show.
     */
    void ShowNumViewers(uint32_t num_channels);
...
public:
    ...
    /**
     * @brief Enable switch timer for switching between 1-channel and n-channel views.
     * @param interval_seconds Interval time in seconds between switches.
     */
    void EnableSwitchTimer(int interval_seconds);
