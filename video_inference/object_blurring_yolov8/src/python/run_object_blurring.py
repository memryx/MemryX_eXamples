...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dfp', type=str, default="../models/YOLO_v8_small_640_640_3_onnx.dfp", help="Specify the path to the compiled DFP file. Default is 'models/YOLO_v8_medium_pose_640_640_3_onnx.dfp'.")
    parser.add_argument('-post', '--post_model', type=str, default="../models/YOLO_v8_small_640_640_3_onnx_post.onnx", help="Specify the path to the post model. Default is 'models/YOLO_v8_medium_pose_640_640_3_onnx_post.onnx.")
